...
urlpatterns = [
    ...
    path('system-admin/clients/new/', views.client_create, name='client_create'),
    path('system-admin/clients/<int:pk>/edit/', views.client_edit, name='client_edit'),
    path('system-admin/employees/<int:pk>/reset-password/',views.employee_reset_password, name='employee_reset_password'),
    path('system-admin/employees/<int:pk>/toggle-status/', views.employee_toggle_status, name='employee_toggle_status'),
